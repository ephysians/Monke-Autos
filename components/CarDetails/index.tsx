...
interface CarDetailsProps {
  isOpen: boolean;
  closeModal: () => void;
  car: CarProps /* -->  using another interface created bf which is coming from @types above...very cool..Omomi */;
}
              ...
              <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                ...
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <div className="mt-3 flex flex-wrap gap-4">
                    {" "}
                    {/*I got the keys of the car object & not values as usual, I did by "Object.entries" & pass an object (car) & it return key & value pears which I destructure finally return a div */}
